...
@interface editPostFilterView ()<TOCropViewControllerDelegate>
{
...
@implementation editPostFilterView
...
{
    [[NSUserDefaults standardUserDefaults] setObject:UIImagePNGRepresentation(image) forKey:@"currentImageEdit"];
    [[NSUserDefaults standardUserDefaults] synchronize];
    
    [editor dismissViewControllerAnimated:YES completion:nil];
    editPostShareView *lvc=[[editPostShareView alloc]init];
